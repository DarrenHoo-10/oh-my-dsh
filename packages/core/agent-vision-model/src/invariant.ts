/**
 * Package-owned invariant companion for the default image-understanding model selection.
 *
 ...
 *
 * @module @deepseek-ai/dsh-agent-vision-model/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-agent-vision-model'

/** Cordis companion plugin name. */
export const name = 'agent-vision-model-invariant'
