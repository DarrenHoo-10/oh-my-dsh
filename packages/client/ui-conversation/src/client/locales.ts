...
export const zh = {
  ...
  'image.visionModelUnsupported': '图片理解模型不支持图片，请在模型设置中更换配置',
  'image.relayFailed': '图片理解失败，请检查图片理解模型的凭据与配置后重试',
  'image.relayFailedDetail': '图片理解失败：{detail}',
  ...
  'details.output': '输出',
  'details.running': '运行中…',
  'details.openLocation': '打开位置',
  'panel.toggleBottom': '切换终端面板',
  'terminal.title': '终端',
  'terminal.starting': '终端工作目录：',
  'terminal.desktopOnly': '终端仅在 DeepSeek Harness 桌面版中可用。',
  'terminal.exited': '终端已退出（代码 {code}）',
  'terminal.placeholder': '输入要执行的命令',
  'terminal.run': '运行',
  'selection.add': '添加到会话',
  'selection.details': '更多详情',
  'selection.sideChat': '在侧边聊天中提问',
  'selection.count': '{count} 个已选文本片段',
  'selection.sentCount': '{count} 条注释',
  'selection.clear': '清除已选文本片段',
  'selection.commentPlaceholder': '添加可选评论…',
  'selection.cancel': '取消',
  'selection.save': '保存',
  'selection.delete': '删除注释',
  'selection.edit': '编辑注释 {index}',
  'selection.selectedText': '所选文本：',
  'selection.comment': '评论：',
  'sideChat.title': '侧边聊天',
  'sideChat.close': '关闭侧边聊天',
  'sideChat.placeholder': '针对所选内容提问',
  'sideChat.send': '发送',
  'sideChat.latest': '最新回答',
  'sideChat.new': '新建侧边聊天',
  'sideChat.loading': '正在载入侧边会话…',
  'sideChat.loadError': '侧边会话载入失败，请关闭后重试。',
  'sideChat.empty': '基于当前对话上下文继续提问。',
  'sideChat.returnToMain': '发送到主会话',
  'sideChat.selectedCount': '{count} 个已选文本片段',
  'todo.title': '任务',
...
export const en = {
  ...
  'image.visionModelUnsupported': 'The image-understanding model does not accept images; change it in model settings',
  'image.relayFailed': 'Image understanding failed; check the image-understanding model credentials and configuration',
  'image.relayFailedDetail': 'Image understanding failed: {detail}',
  ...
  'details.openLocation': 'Open location',
  'panel.toggleBottom': 'Toggle terminal panel',
  'terminal.title': 'Terminal',
  'terminal.starting': 'Terminal working directory:',
  'terminal.desktopOnly': 'The terminal is available in DeepSeek Harness Desktop.',
  'terminal.exited': 'Terminal exited (code {code})',
  'terminal.placeholder': 'Enter a command',
  'terminal.run': 'Run',
  'selection.add': 'Add to conversation',
  'selection.details': 'More details',
  'selection.sideChat': 'Ask in side chat',
  'selection.count': '{count} selected text excerpts',
  'selection.sentCount': '{count} annotation(s)',
  'selection.clear': 'Clear selected text excerpts',
  'selection.commentPlaceholder': 'Add an optional comment…',
  'selection.cancel': 'Cancel',
  'selection.save': 'Save',
  'selection.delete': 'Delete annotation',
  'selection.edit': 'Edit annotation {index}',
  'selection.selectedText': 'Selected text:',
  'selection.comment': 'Comment:',
  'sideChat.title': 'Side chat',
  'sideChat.close': 'Close side chat',
  'sideChat.placeholder': 'Ask about the selected text',
  'sideChat.send': 'Send',
  'sideChat.latest': 'Latest answer',
  'sideChat.new': 'New side chat',
  'sideChat.loading': 'Loading side conversation…',
  'sideChat.loadError': 'The side conversation failed to load. Close it and try again.',
  'sideChat.empty': 'Ask follow-up questions with the current conversation context.',
  'sideChat.returnToMain': 'Send to main conversation',
  'sideChat.selectedCount': '{count} selected text excerpt',
  'todo.title': 'To-dos',
