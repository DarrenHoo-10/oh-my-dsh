...
export const en = {
  ...
  visionTitle: 'Image-understanding model',
  visionUnset: 'Not configured: images sent to a model without image input are refused. Selecting a model relays images to text first.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelSupportsImage: '支持图片',
  visionTitle: '图片理解模型',
  visionUnset: '未配置：向不支持图片的模型发送图片会被拒绝。选择模型后，图片会先由该模型转换为文本。',
  visionProvider: '视觉提供方',
  visionModel: '视觉模型',
  visionClear: '清除',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
